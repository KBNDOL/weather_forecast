...
def predict_coco_from_excel(excel_path):
    # 加载保存的模型和归一化对象
    temp_model = load_model('model/forecast_future_coco.keras')
